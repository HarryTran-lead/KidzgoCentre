 ...
 * Admin/ManagementStaff: update a category
 */
export async function PUT(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const upstream = await fetch(buildApiUrl(BACKEND_FAQ_ENDPOINTS.CATEGORY_BY_ID(id)), {
    method: "PUT",
 ...
 * Admin/ManagementStaff: soft-delete a category
 */
