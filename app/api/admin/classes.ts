...
function mapApiClassToRow(item: any): ClassRow {
  ...
  return {
    ...
    levelId: item?.levelId ?? item?.level?.id ?? null,
    levelName: item?.levelName ?? item?.level?.name ?? null,
    startModuleId: item?.startModuleId ?? null,
    startModuleName: item?.startModuleName ?? null,
    startSessionIndex: item?.startSessionIndex ?? null,
    currentModuleId: item?.currentModuleId ?? null,
    currentModuleName: item?.currentModuleName ?? null,
    currentSessionIndex: item?.currentSessionIndex ?? null,
...
export async function fetchAndMapAdminClassDetail(classId: string): Promise<ClassDetail> {
  ...
  const classDetail: ClassDetail = {
    ...
    levelId: apiData?.levelId ?? null,
    levelName: apiData?.levelName ?? null,
    startModuleId: apiData?.startModuleId ?? null,
    startModuleName: apiData?.startModuleName ?? null,
    startSessionIndex: apiData?.startSessionIndex ?? null,
    currentModuleId: apiData?.currentModuleId ?? null,
    currentModuleName: apiData?.currentModuleName ?? null,
    currentSessionIndex: apiData?.currentSessionIndex ?? null,
    currentLessonTitle: apiData?.currentLessonTitle ?? null,
