...
export default function AdminDocumentsPage({ params }: { params: { locale: string } }) {
  return (
    <div>
      <div className="flex items-center gap-2 bg-white border-b border-gray-100 px-4 py-2.5 text-sm">
        <Link
          href={`/${params.locale}/portal/admin/courses`}
        ...
        <Link
          href={`/${params.locale}/portal/admin/syllabuses`}
          className="font-medium text-gray-500 hover:text-red-600 transition-colors"
        >
          Syllabus
        </Link>
