    ...
    <div className="rounded-2xl border border-red-200 bg-white p-6 space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-3">
        <div className="rounded-xl border border-red-100 bg-red-50 p-4">
          ...
          <p className="text-sm text-red-700 mt-1">Speaking +12%, Reading +8% so với tuần trước.</p>
        </div>
        <div className="rounded-xl border border-gray-200 p-4">
          <div className="text-sm font-semibold text-gray-900 flex items-center gap-2">
            <BookOpen size={18} /> Bài tập & tài liệu
          </div>
          <p className="text-sm text-gray-600 mt-1">Xem chi tiết từng bài nộp, điểm số và tài liệu giáo viên gửi.</p>
        </div>
      </div>
    </div>
  );
