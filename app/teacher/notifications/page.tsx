...
export default function Page() {
  const list = [
    { title: "Lịch dạy cập nhật", desc: "Lớp A1 chuyển sang P301 từ 12/10", tag: "Thông tin", color: "blue" as const, time: "2 giờ trước" },
    { title: "Nhắc điểm danh", desc: "Chưa điểm danh buổi 08/10 lớp TOEIC", tag: "Quan trọng", color: "red" as const, time: "1 ngày trước" },
  ];
