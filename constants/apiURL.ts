...
export const ENROLLMENT_ENDPOINTS = {
  ...
  BACKFILL_SESSION_ASSIGNMENTS: '/api/enrollments/backfill-session-assignments',
  UPDATE: (id: string) => `/api/enrollments/${id}`,
  SCHEDULE_SEGMENTS: (id: string) => `/api/enrollments/${id}/schedule-segments`,
...
export const BACKEND_ENROLLMENT_ENDPOINTS = {
  ...
  CREATE: '/enrollments',
  BACKFILL_SESSION_ASSIGNMENTS: '/enrollments/backfill-session-assignments',
  UPDATE: (id: string) => `/enrollments/${id}`,
  SCHEDULE_SEGMENTS: (id: string) => `/enrollments/${id}/schedule-segments`,
