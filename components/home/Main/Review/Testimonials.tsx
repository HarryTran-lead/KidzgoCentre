          ...
          >
            <span className="relative inline-block">
              <span className="text-white drop-shadow-lg">
                Câu chuyện{" "}
                <span className="relative inline-block">
                  <span className="relative z-10 bg-linear-to-r from-white to-white bg-clip-text text-transparent">
                    thành công
                  </span>
                  <motion.span
                    className="absolute -bottom-2 left-0 w-full h-1 bg-linear-to-r from-amber-300 via-rose-300 to-pink-300 rounded-full"
                    initial={{ scaleX: 0 }}
