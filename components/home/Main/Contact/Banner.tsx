...
import { MessageSquare, Sparkles, Zap, Compass, Rocket, ChevronDown, Circle, Hexagon, Triangle, Phone, Mail, MapPin, Clock } from "lucide-react";
...
export default function BannerContact() {
  ...
  return (
    <header 
      ...
      className="contact-banner relative overflow-hidden bg-gradient-to-br from-red-600 via-red-500 to-rose-600 pb-24 sm:pb-28 sticky top-0 z-10"
      style={{ opacity }}
    >
        ...
        >
          ...
          <div className="flex flex-col justify-center space-y-4 sm:space-y-6 lg:col-span-3">
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl md:text-[40px] font-black text-white leading-tight mb-3 drop-shadow-lg">
                ...
                {" "}
                <motion.span 
                  className="text-rose-200 inline-block"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
              ...
              <motion.div 
                className="h-1.5 w-24 bg-yellow-300 rounded-full shadow-lg"
                initial={{ width: 0 }}
                animate={{ width: 96 }}
            ...
            {/* Contact Methods with 3D hover effect */}
                ...
                >
                  ...
                  <div className="relative">
                    <div className="text-xs sm:text-sm text-white/90 font-medium flex items-center gap-1">
                      <method.icon size={12} className="group-hover:rotate-12 transition-transform" />
                      {method.label}
                    </div>
            ...
            {/* Contact Now Button with Down Arrow */}
            <motion.button
              onClick={scrollToContact}
              className="group relative mt-4 px-8 py-3.5 bg-white text-red-600 rounded-xl font-bold flex items-center gap-3 w-fit shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden cursor-pointer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
          ...
          <div className="hidden lg:flex items-center justify-end lg:col-span-2">
            <div className="relative w-full max-w-sm h-80 flex items-center justify-center">
              ...
              {[
                { Icon: Phone, delay: 0, x: -90, y: -40, floatRange: 15 },
                { Icon: Mail, delay: 0.5, x: 90, y: -30, floatRange: 12 },
                { Icon: MapPin, delay: 1, x: -80, y: 50, floatRange: 18 },
                { Icon: Clock, delay: 1.5, x: 85, y: 60, floatRange: 14 },
              ].map((item, i) => (
                <motion.div
                  key={i}
      ...
      <motion.div
        ...
        onClick={scrollToContact}
      >
        <div className="text-white/60 text-xs font-medium">Liên Hệ Ngay</div>
