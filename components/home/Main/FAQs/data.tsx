...
export const categories: FAQCategory[] = [
  { name: "all", icon: <HelpCircle className="w-4 h-4 text-red-600" /> },
  { name: "enrollment", icon: <UserPlus className="w-4 h-4 text-red-600" /> },
  { name: "tuition", icon: <CreditCard className="w-4 h-4 text-red-600" /> },
  {
    name: "schedule",
    icon: <CalendarClock className="w-4 h-4 text-red-600" />,
  },
  {
    name: "attendance",
    icon: <ClipboardCheck className="w-4 h-4 text-red-600" />,
  },
  { name: "portal", icon: <Smartphone className="w-4 h-4 text-red-600" /> },
  {
    name: "learning",
    icon: <BookOpenCheck className="w-4 h-4 text-red-600" />,
  },
  { name: "technical", icon: <Wrench className="w-4 h-4 text-red-600" /> },
];
