  ...
  return (
    <div className="rounded-2xl border border-red-200 bg-gradient-to-br from-white to-red-50 p-4 transition-all duration-700 delay-100">
      <div className="space-y-4">
            ...
            return (
              ...
              >
                <span className="inline-flex items-center gap-2">
                  {statusLabel === "Tất cả" ? "Tất cả trạng thái" : statusLabel}
                  <span
        ...
        {/* Search, Source Select, and My Leads Checkbox */}
        <div className="flex flex-col lg:flex-row gap-4 lg:items-center">
          ...
          {onMyLeadsOnlyChange && currentUserName && (
            <label className="flex items-center gap-2 px-3 py-2 rounded-xl border border-gray-200 bg-white cursor-pointer hover:bg-gray-100 transition-colors whitespace-nowrap">
              <input
                type="checkbox"
                checked={myLeadsOnly}
