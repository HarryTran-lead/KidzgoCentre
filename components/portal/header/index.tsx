    ...
    titleFor(role: Role, userName?: string, pageTitle?: string, pathname?: string) {
      ...
      if (role === "Admin" && pathname) {
        const pathMap: Record<string, { vi: string; en: string }> = {
          ...
          "/courses": { vi: "Chương trình", en: "Programs" },
          "/syllabuses": { vi: "Giáo trình", en: "Syllabuses" },
          "/documents/templates": { vi: "Mẫu giáo án chuẩn", en: "Standard Lesson Templates" },
          "/documents/plans": { vi: "Giáo án lớp", en: "Class Lesson Plans" },
          "/academic-progression": { vi: "Tiến trình học thuật", en: "Academic Progression" },
