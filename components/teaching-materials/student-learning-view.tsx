          ...
          <div className={cn(
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 bg-white/5 flex-shrink-0">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button onClick={() => doDownload(viewingMaterial)} className="p-2 rounded-lg hover:bg-white/10 text-white/60 hover:text-white transition-colors" title="Tải xuống">
                  <Download size={16} />
                </button>
                <button onClick={() => setFullscreen(!fullscreen)} className="p-2 rounded-lg hover:bg-white/10 text-white/60 hover:text-white transition-colors" title="Phóng to">
                  {fullscreen ? <Minimize2 size={16} /> : <Maximize2 size={16} />}
                </button>
                <button onClick={closeViewer} className="p-2 rounded-lg hover:bg-white/10 text-white/60 hover:text-white transition-colors" title="Đóng">
                  <X size={16} />
                </button>
              </div>
            </div>
  ...
  return (
    <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/10 hover:border-white/20 transition-colors group">
      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        ...
        {!isDownloadOnly && (
          <button onClick={onDownload} className="p-2 rounded-lg hover:bg-white/10 text-white/40 hover:text-white transition-colors" title="Tải xuống">
            <Download size={14} />
          </button>
        )}
      </div>
