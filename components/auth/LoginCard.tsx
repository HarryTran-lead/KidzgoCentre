                ...
                >
                  ...
                  <div className="space-y-5">
                    ...
                    <motion.button
                      ...
                      className="w-full bg-linear-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700 text-white text-sm font-semibold py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer"
                    >
                      Đăng nhập ngay
                    </motion.button>
                  </div>
