        ...
        <div className="w-full max-w-5xl">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-lg font-bold text-white">KidzGo</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              />
                    ...
                    onChange={() => setAgreeTerms(!agreeTerms)}
                          className="h-3.5 w-3.5 mt-0.5 rounded border-gray-300 text-pink-600 focus:ring-pink-600"
                  />
                ...
                animate={{ opacity: 1, y: 0 }}
                    ...
                    <div className="pt-3 border-t border-gray-200 text-center">
                      <p className="text-xs text-gray-600">
                        Đã có tài khoản?{" "}
                        <Link href={`/${resolvedLocale}/auth/login`} className="text-pink-600 hover:text-pink-700 font-medium">
                          Đăng nhập ngay
                        </Link>
                </p>
              </div>
